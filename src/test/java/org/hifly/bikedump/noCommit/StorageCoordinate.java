 ...
 * @date 01/02/14
 */
public class StorageCoordinate {
    public static void main (String[]args) throws Exception {
        ...
        try {
            ...
            for (Iterator iterator = files.iterator(); iterator.hasNext();) {
                ...
                if(file.getName().endsWith("storage_coordinates.db")
                        ||
                        file.getName().endsWith("storage.log")
                        ||
                        file.getName().endsWith("storage_kyro.log")
                        ||
                        file.getName().endsWith("storage_coordinates_kyro.db"))
                    continue;
            ...
            File file = new File(
                    "/home/hifly/Dropbox/Docs/CYCLING_MTB/ROUTE/elevation_stats/storage.log");
            ...
            File file2 = new File(
                    "/home/hifly/Dropbox/Docs/CYCLING_MTB/ROUTE/elevation_stats/storage_coordinates.db");
            file2.delete();

            FileOutputStream fos =
                    new FileOutputStream("/home/hifly/Dropbox/Docs/CYCLING_MTB/ROUTE/elevation_stats/storage_coordinates.db");
